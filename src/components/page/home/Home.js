                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="introText">
                                    <h1 className="wow fadeInUp" animation-delay="0.2s" data-wow-delay="0.2s"><span className="text-uppercase text-color">Riseup</span><br />Beyond Reality Driving <br />into Technology</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div className="swap-apps">
                                                    ...
                                                    <div className="col-lg-8 col-md-12">
                                                        <div className="apps-description">
                                                            ...
                                                            <Link to="/apps-development" className="see-more">See More<i className="fas fa-arrow-right"></i></Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="swap-apps">
                                                    ...
                                                    <div className="col-lg-8">
                                                        <div className="apps-description">
                                                            ...
                                                            <Link to={`${process.env.PUBLIC_URL}/`} className="see-more">See More<i className="fas fa-arrow-right"></i></Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="swap-apps">
                                                    ...
                                                    <div className="col-lg-8">
                                                        <div className="apps-description">
                                                            ...
                                                            <Link to="/iets" className="see-more">See More<i className="fas fa-arrow-right"></i></Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
